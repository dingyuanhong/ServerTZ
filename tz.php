...
{
	$speed=round(100*100/($_POST['speed']/1000),2);
}
elseif($_GET['speed']=="0")
{
	$speed=6666.67;
...
{
	$speed=round(100*100/($_GET['speed']/1000),2); //下载速度：$speed kb/s
}
else
{
...
<script language="JavaScript" type="text/javascript" rel="noreferrer" src="http://lib.sinaapp.com/js/jquery/1.7/jquery.min.js"></script>
